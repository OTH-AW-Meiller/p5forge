const PROCESSING_SUGGESTIONS = [
  ...
  { insert: "loadShape", detail: "loadShape(path)", appendText: "(\"path/to/shape.svg\");" },
  { insert: "createShape", detail: "createShape([kind, ...])", appendText: "();" },
  { insert: "shape", detail: "shape(sh, x, y, [w, h])", appendText: "(sh, x, y);" },
  { insert: "shapeMode", detail: "shapeMode(CORNER | CORNERS | CENTER)", appendText: "(CORNER);" },
